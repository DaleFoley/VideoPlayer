...
DEFINE('PATH_FFMPEG_LINUX', APP_PATH . "\\ffmpeg\\linux\\ffmpeg.exe");
DEFINE('PATH_FFPLAY_LINUX', APP_PATH . "\\ffmpeg\\linux\\ffplay.exe");
DEFINE('PATH_FFPROBE_LINUX', APP_PATH . "\\ffmpeg\\linux\\ffprobe.exe");